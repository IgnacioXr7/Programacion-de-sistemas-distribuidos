...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.133 2025-10-19 17:03:05 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "bkackJackns:playerMove"))
		return soap_serve_bkackJackns__playerMove(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_bkackJackns__playerMove(struct soap *soap)
{	struct bkackJackns__playerMove soap_tmp_bkackJackns__playerMove;
	struct bkackJackns__playerMoveResponse soap_tmp_bkackJackns__playerMoveResponse;
	struct tBlock soap_tmp_blackJackns__tBlock;
	soap_default_bkackJackns__playerMoveResponse(soap, &soap_tmp_bkackJackns__playerMoveResponse);
	soap_default_blackJackns__tBlock(soap, &soap_tmp_blackJackns__tBlock);
	soap_tmp_bkackJackns__playerMoveResponse.status = &soap_tmp_blackJackns__tBlock;
	soap_default_bkackJackns__playerMove(soap, &soap_tmp_bkackJackns__playerMove);
	if (!soap_get_bkackJackns__playerMove(soap, &soap_tmp_bkackJackns__playerMove, "bkackJackns:playerMove", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = bkackJackns__playerMove(soap, soap_tmp_bkackJackns__playerMove.playerName, soap_tmp_bkackJackns__playerMove.gameId, soap_tmp_bkackJackns__playerMoveResponse.status);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize_bkackJackns__playerMoveResponse(soap, &soap_tmp_bkackJackns__playerMoveResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_bkackJackns__playerMoveResponse(soap, &soap_tmp_bkackJackns__playerMoveResponse, "bkackJackns:playerMoveResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
