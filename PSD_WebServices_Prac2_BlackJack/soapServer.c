...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.133 2025-10-19 17:17:28 GMT")
...
{	struct blackJackns__playerMove soap_tmp_blackJackns__playerMove;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__playerMove(soap, soap_tmp_blackJackns__playerMove.playerName, soap_tmp_blackJackns__playerMove.gameId, soap_tmp_blackJackns__playerMove.action, soap_tmp_blackJackns__playerMoveResponse.status);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
